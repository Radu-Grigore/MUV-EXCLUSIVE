...
export function Hero() {
    ...
    return (
        <section ref={root} id="top" className="relative isolate flex min-h-[640px] flex-col overflow-hidden pt-[72px] lg:min-h-[720px]" style={{ height: '100svh' }}>
            <div
                className="pointer-events-none absolute inset-0 -z-10"
                style={{
                    background:
                        'radial-gradient(60% 55% at 78% 30%, rgba(230,207,166,0.55) 0%, transparent 70%), radial-gradient(50% 45% at 10% 90%, rgba(227,212,195,0.9) 0%, transparent 70%)',
                }}
            />
            ...
            <div className="relative mx-auto flex w-full max-w-[1440px] flex-1 flex-col px-5 sm:px-8 lg:px-12">
                ...
                <div className="relative z-20 flex items-start justify-between gap-6 pt-6 lg:pt-10">
                    <div className="max-w-[20rem]">
                        <p data-hero-fade className="eyebrow flex items-center gap-3 text-bronze">
                            <span className="h-px w-8 bg-gold" /> În curând în {site.city}
                        </p>
                ...
                >
                    ...
                    <div
                        data-hero-badge
                        className="absolute top-[14%] -left-12 z-20 grid h-24 w-24 place-items-center rounded-full bg-espresso text-cream shadow-xl sm:-left-16 sm:h-28 sm:w-28 lg:h-32 lg:w-32"
                    >
                        <svg viewBox="0 0 100 100" className="absolute inset-0 h-full w-full animate-spin-slow text-gold-soft" aria-hidden="true">
                            <defs>
                                <path id="badge-circle" d="M50,50 m-38,0 a38,38 0 1,1 76,0 a38,38 0 1,1 -76,0" />
                            </defs>
                            <text className="fill-current text-[8.4px] tracking-[0.28em] uppercase">
                                <textPath href="#badge-circle">Deschidere oficială · Ploiești ·</textPath>
                            </text>
                        </svg>
                        <span className="text-center leading-none">
                            <span className="block font-display text-2xl font-semibold sm:text-3xl">01.11</span>
                            <span className="text-[0.5rem] tracking-[0.3em] text-gold-soft">2026</span>
                        </span>
                    </div>
                    <p
                        data-hero-fade
                        className="absolute -bottom-5 -right-16 hidden font-script text-6xl leading-none text-bronze drop-shadow-[0_2px_10px_rgba(247,241,234,0.9)] sm:block"
                    >
                        Women Only
                    </p>
                </div>
                ...
                <div data-hero-word className="relative z-20 mt-auto pb-24 sm:pb-8 lg:pb-10">
                    <h1 className="flex flex-col">
                        ...
                        <span aria-hidden="true" data-hero-fade className="mt-3 flex items-center gap-4 pl-[1.2vw]">
                            ...
                            <span className="ml-auto font-script text-[2rem] leading-none whitespace-nowrap text-bronze sm:hidden">Women Only</span>
                        </span>
                    </h1>
                </div>
