...
export function Opening() {
    ...
    return (
        <section ref={root} id="deschidere" className="relative overflow-hidden bg-ink py-28 text-cream sm:py-40">
            <div
                data-ring
                className="pointer-events-none absolute top-1/2 left-1/2 aspect-square w-[140vw] max-w-[860px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-gold/30 shadow-[0_0_120px_10px_rgba(199,160,106,0.22),inset_0_0_120px_10px_rgba(199,160,106,0.1)] sm:w-[90vw]"
            />
